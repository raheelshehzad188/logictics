                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card card-primary card-outline">
                            <form id="remove-avatar-form"
                                  action="{{ route('admin.my-profile.avatar.delete', [$user]) }}" method="POST"
                                  style="display: none;">
                                @csrf
                                @method('delete')
                            </form>
                            ...
                            <!-- form start -->
                            <form method="POST" action="{{ route('admin.my-profile.update', [$user]) }}"
                                  enctype="multipart/form-data" role="form" id="form" class="needs-validation">
                                @csrf
                                        ...
                                        <div class="col-md-6">
                                            <div class="d-flex flex-column justify-content-center align-items-center">
                                                <img src="{{ $user->avatar_url }}"
                                                     onerror="this.onerror=null; this.src='{{ asset('themes/AdminLTE/dist/img/avatar5.png') }}';"
                                                     id="profile_img" class="img-circle mb-2" height="200"
                                                     width="200" alt=""/>
                                                ...
                                                <div class="w-100 d-flex" style="justify-content: space-evenly">
                                                    ...
                                                    @unless (!$user->avatar)
                                                        <a class="btn btn-sm btn-danger"
                                                           onclick="event.preventDefault(); $('#remove-avatar-form').submit();">
