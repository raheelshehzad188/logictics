        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row align-items-center mt-2">
                    ...
                    <div class="col-md-6">
                        <a href="{{ route('admin.masters.areas.create') }}"
                                        ...
                                        <table class="table" id="table" style="margin: 0 !important;">
                                            ...
                                            @foreach($areas as $area)
                                                <tr>
                                                    <td>{{ $area->id }}</td>
                                                    <td>{{ $area->name }}</td>
                                                    <td>{{ optional($area->governorate)->name}}</td>
                                                    @if($area->status == '1')
                                                    ...
                                                    @endif
                                                    <td>
                                                        <a href="{{ route('admin.masters.areas.edit',$area->id) }}"
                                                           class="btn btn-sm btn-primary">Edit</a>
                                                        &nbsp;<a
                                                            href="{{route('admin.masters.areas.destroy',$area->id)}}"
                                                            class="btn btn-sm btn-danger"
                                                            data-confirm="Are you sure to delete this area ?">
                                                            Delete </a>
                                                    </td>
                                                </tr>
                                            @endforeach
