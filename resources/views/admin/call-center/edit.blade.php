                ...
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        ...
                        <div class="card card-primary card-outline">
                            <!-- form start -->
                            <form method="POST"
                                  action="{{route('admin.callcenter.callcenter.update' ,$callcenters->id) }}"
                                    ...
                                    <div class="row mt-6">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="username" value="{{$callcenters->email}}"
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <select name="status"
                                                    ...
                                                    <option value="1" @if($callcenters->status == '1') selected @endif>
                                                        Active
                                                    </option>
                                                    <option value="0" @if($callcenters->status == '0') selected @endif>
                                                        Inactive
                                                    </option>
                                                </select>
