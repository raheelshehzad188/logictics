...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="m-0 text-dark">Out For Delivery</h4>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
    ...
    @endcomponent -->
                    ...
                    <div class="col-md-6">
                        <a href="#" class="btn btn-sm bg-gradient-warning float-right" onclick="assignToDriver()">
                            <span class="fa fa-truck"></span> Assign to driver</a>
                        <a href="#" class="btn btn-sm bg-gradient-success float-right mr-3" onclick="printSticker()">
                            <span class="fa fa-print"></span> Print stickers</a>
    ...
    <!-- Model Expert-->
    <div class="modal fade" id="assign_to_driver_modal" aria-modal="true" role="dialog">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title text-center" style="width: 100%;">Assign To Driver</h4>
                </div>
                <div class="modal-body">
                    <form action="{{ route('admin.cards.assignDriver') }}" class="form-horizontal" autocomplete="off"
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="driver_id">Drivers<span class="requiredAsterisk">*</span></label>
                                        <select class="form-control js-select2 @error('driver_id') is-invalid @enderror"
                                            style="width: 100%;" id="driver_id" name="driver_id">
                                            <option value=" ">---Select---</option>
                                            @foreach ($all_drivers as $row_driver)
                                                <option value="{{ $row_driver['id'] }}">{{ $row_driver['driver_name'] }}
                                                    ({{ $row_driver['capacity'] ?? 'NA' }})
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('driver_id')
                        ...
                        <div style="display: flex;justify-content: space-around;">
                            <button type="submit" class="btn btn-success btn-flat"
                                style="border-radius: 5px; width: 100px;"><span class="fa fa-check-circle"
                                    onclick="return hidepopup();"></span> Save
                            </button>
                        </div>
                    </form>
    ...
    <!-- Model For Menifest -->
    <div class="modal fade" id="sticker_modal" aria-modal="true" role="dialog">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title text-center" style="width: 100%;">Are you sure to print stickers?</h4>
                </div>
                <div class="modal-body">
                    <form id="menifest_form" target="_blank" action="{{ route('admin.cards.printStickers') }}"
    ...
    <div class="modal fade" id="update_card_status_modal" aria-modal="true" role="dialog">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.cards.updateCardStatus') }}" class="form-horizontal"
...
@section('footer')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            table = $('#table').DataTable({
                ...
                buttons: [{
                        ...
                        text: 'PDF',
                        title: '',
                        filename: 'Out-for-Delivery-' + current_datetime,
                        exportOptions: {
                            orthogonal: 'export',
                ...
                'ajax': {
                    ...
                    type: 'GET',
                    data: function(d) {
                        d.type = 'out_for_delivery';
                        d.datetimes = $("#f_datetimes").val();
                        d.agent_id = $("#f_agent_id").val();
        ...
        function assignToDriver() {
            ...
            $('#assign_to_driver_modal').modal('show');
            table.rows({
                selected: true
            }).data().each(function(data) {
                $('<input>').attr({
