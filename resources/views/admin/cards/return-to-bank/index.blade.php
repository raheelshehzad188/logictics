    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="m-0 text-dark">Return to bank</h4>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Home</a></li>
                            <li class="breadcrumb-item">Card Management</li>
                            <li class="breadcrumb-item active">Return to bank</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                                        ...
                                        <select name="status"
                                            ...
                                            @foreach ($all_status as $row_status)
                                                @if ($row_status['parent_id'] == 0 && $row_status->id != 3)
                                                    <option value="{{ $row_status->id }}">{{ $row_status->name }}</option>
                                                @endif
                                            @endforeach
        ...
        $(document).ready(function() {
            ...
            table = $('#table').DataTable({
                ...
                buttons: [{
                        ...
                        text: 'PDF',
                        title: '',
                        filename: 'Return-to-Bank-' + current_datetime,
                        exportOptions: {
                            orthogonal: 'export',
                            columns: [2, 3, 4, 5, 6, 7, 8, 9, 10, 14]
                        },
