    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="m-0 text-dark">Unassigned</h4>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
    ...
    @endcomponent -->
                    ...
                    <div class="col-md-6">
                        <a href="#" class="btn btn-sm bg-gradient-success float-right"
                            onclick="updateCardStatus()"><span class="fa fa-save"></span> Reassign to Agent</a>
                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="row mt-6">
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <label>Status</label>
                                                    <select id="f_status" class="form-control js-select2 filter_clear">
        ...
        $(document).ready(function() {
            ...
            table = $('#table').DataTable({
                ...
                buttons: [{
                        ...
                        text: 'PDF',
                        title: '',
                        filename: 'Unassigned-' + current_datetime,
                        exportOptions: {
                            orthogonal: 'export',
