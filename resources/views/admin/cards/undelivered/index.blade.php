...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="m-0 text-dark">Undelivered</h4>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Home</a></li>
                            <li class="breadcrumb-item">Card Management</li>
                            <li class="breadcrumb-item active">Undelivered</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
    ...
    @endcomponent -->
                    ...
                    <div class="col-md-6">
                        <!-- <a href="#" class="btn btn-sm bg-gradient-primary float-right mr-3"> Assign to driver</a> -->
        ...
        $(document).ready(function() {
            ...
            table = $('#table').DataTable({
                ...
                buttons: [{
                        ...
                        text: 'PDF',
                        title: '',
                        filename: 'Undelivered-' + current_datetime,
                        exportOptions: {
                            orthogonal: 'export',
