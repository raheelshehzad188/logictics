...
<head>
    ...
    <!-- overlayScrollbars -->
    <link rel="stylesheet"
          href="{{ asset('themes/AdminLTE/plugins/overlayScrollbars/css/OverlayScrollbars.min.css') }}">
    <!-- Theme style -->
...
<div class="login-box">
    <div class="login-logo">
        ...
        <img src="{{ asset('header-logo.png') }}" alt="Logo" class="brand-image mb-5"
             style="opacity: 1; width: 100px">
    </div>
    <!-- /.login-logo -->
    <div class="card">
        <div class="card-body login-card-body">
            <p class="login-box-msg">Welcome to G&P Logistics</p>
