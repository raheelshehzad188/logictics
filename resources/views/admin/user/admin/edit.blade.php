                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.users.admins.index') }}">Admins</a>
                            </li>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        ...
                        <div class="card card-primary card-outline">
                            <form id="remove-image-form"
                                  action="{{ route('admin.users.admins.avatar.delete', [$user]) }}" method="POST"
                                  style="display: none;">
                                @csrf
                                @method('delete')
                            </form>
                            ...
                            <!-- form start -->
                            <form method="POST" action="{{ route('admin.users.admins.update', [$user]) }}" role="form"
                                        ...
                                        <div class="col-md-6">
                                            <div class="d-flex flex-column justify-content-center align-items-center">
                                                ...
                                                <input type="file" name="avatar"
                                                       class="js-image-upload form-control d-none"
                                                       accept='.jpg, .jpeg, .png'
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="civil_id_number"
                                                       value="{{ $user->civil_id_number }}"
                                                       class="form-control @error('civil_id_number') is-invalid @enderror">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <select name="roles[]" multiple
                                                        class="form-control js-select2 @error('roles') is-invalid @enderror">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <select name="status"
                                                    ...
                                                    <option value="1" {{ $user->status == '1' ? 'selected' : null }}>
                                                        Active
                                                    </option>
                                                    <option value="0" {{ $user->status == '0' ? 'selected' : null }}>
                                                        Inactive
                                                    </option>
                                                </select>
